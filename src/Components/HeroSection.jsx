    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full px-5 text-center mt-40 sm:mt-38 md:mt-32">
        ...
        <motion.div
          ...
          className="mt-5 w-14 h-14 flex items-center justify-center rounded-full border-2 border-white/30 bg-white/10 shadow-lg backdrop-blur-sm hover:scale-110 transition-all duration-300 cursor-pointer"
          onClick={() => {
