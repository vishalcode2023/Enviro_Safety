        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start text-gray-400">
              ...
              <a href="mailto:vishalcode2023@gmail.com" className="hover:text-white transition-colors duration-300">envirosafetyglass@gmail.com</a>
            </li>
            <li className="flex items-start text-gray-400">
              <Phone size={20} className="mr-3 mt-1 flex-shrink-0" />
              <a href="tel:+91 90087 00000" className="hover:text-white transition-colors duration-300">+91 90087 00000</a>
            </li>
            <li className="flex items-start text-gray-400">
              <MapPin size={20} className="mr-3 mt-1 flex-shrink-0" />
              <span>Plot No.53 ,2nd Stage, Hebbal Industrial Area, Anagahalli, Karnataka 570018</span>
            </li>
          </ul>
        </div>
