  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Pioneering glass innovations with unmatched expertise for
            automotive, architectural, and industrial applications.
          </p>
          {/* Social Media Icons */}
          <div className="flex space-x-4 mt-6">
            <a
              href="https://www.facebook.com/sharer.php?u=https://www.indiamart.com/envirosafetyglass/"
              target="_blank"
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start text-gray-400">
              ...
              <a
                href="mailto:envirosafetyglass07@gmail.com"
                className="hover:text-white transition-colors duration-300"
              >
                envirosafetyglass07@gmail.com
              </a>
            </li>
            <li className="flex items-start text-gray-400">
            ...
            <li className="flex items-start text-gray-400">
              ...
              <span>
                Plot No.53 ,2nd Stage, Hebbal Industrial Area, Anagahalli,
                Karnataka
              </span>
            </li>
            <li className="flex items-start text-gray-400">
      ...
      <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-500 text-sm">
        <p>
          © {new Date().getFullYear()} Enviro Safety Glass. All rights reserved.
        </p>
