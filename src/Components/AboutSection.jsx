      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <p className="text-gray-700 text-base sm:text-lg">
            At <span className="font-semibold text-indigo-700">Enviro Safety Glass</span>, we blend
            modern elegance with industrial innovation. Our glass solutions are engineered for strength,
            style, and performance—perfect for both architectural and interior design.
          </p>
        </div>
      ...
      <div className="mt-16 grid md:grid-cols-2 items-start gap-10">
        ...
        <div className="text-left max-w-xl">
          ...
          <p className="text-gray-600 text-lg">
            At <span className="font-semibold text-indigo-700">Enviro Safety Glass</span>, we believe
            in building environments that reflect durability, transparency, and modern aesthetics.
            Each piece of glass we craft is a statement of quality and innovation.
          </p>
        </div>
      </div>
    </section>
